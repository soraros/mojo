...
class Agent:
    ...
    def get_localMD(self) -> bytes: ...
    def get_local_partialMD(
        self,
        descs: RegistrationDescriptorList,
        inc_conn_info: bool = False,
        backends: Sequence[int] = [],
    ) -> bytes: ...
    def load_remoteMD(self, remote_metadata: str) -> bytes: ...
    def invalidate_remoteMD(self, remote_agent: str) -> Status: ...
    def send_localMD(self, ip_addr: str = "", port: int = 0) -> None: ...
    def send_local_partialMD(
        self,
        descs: RegistrationDescriptorList,
        inc_conn_info: bool = False,
        backends: Sequence[int] = [],
    ...
    def invalidate_localMD(self, ip_addr: str = "", port: int = 0) -> None: ...
    def check_remoteMD(
