...
def test_hash_simd_values():
    ...
    assert_equal(hash(Scalar[DType.float16](1.5)), 17170570249477226196)
    assert_equal(hash(Scalar[DType.float32](1.5)), 13132675331935815936)
    assert_equal(hash(Scalar[DType.float64](1.5)), 5099020174652265565)
    assert_equal(hash(Scalar[DType.float16](1)), 2425465491952508383)
    assert_equal(hash(Scalar[DType.float32](1)), 7268380206556411294)
    assert_equal(hash(Scalar[DType.float64](1)), 1824371972732385641)

    assert_equal(hash(Scalar[DType.bool](True)), 7121024052126637824)
    assert_equal(hash(Scalar[DType.int8](1)), 7121024052126637824)
    assert_equal(hash(Scalar[DType.int16](1)), 7121024052126637824)
    assert_equal(hash(Scalar[DType.int32](1)), 7121024052126637824)
    assert_equal(hash(Scalar[DType.int64](1)), 7121024052126637824)
    assert_equal(hash(Scalar[DType.uint8](1)), 7121024052126637824)
    assert_equal(hash(Scalar[DType.int128](1)), 5122900632109575720)
    assert_equal(hash(SIMD[DType.int64, 2](1, 0)), 5122900632109575720)
    assert_equal(hash(Scalar[DType.int256](1)), 1160009272114074316)
    ...
    assert_equal(hash(Scalar[DType.int8](-1)), 14422269892667380249)
    assert_equal(hash(Scalar[DType.int16](-1)), 11448219905088272650)
    assert_equal(hash(Scalar[DType.int32](-1)), 3690585083486137738)
    assert_equal(hash(Scalar[DType.int64](-1)), 3480139124131340807)
    assert_equal(hash(Scalar[DType.int128](-1)), 11199890586389833974)
    assert_equal(hash(SIMD[DType.int64, 2](-1)), 11199890586389833974)
    assert_equal(hash(Scalar[DType.int256](-1)), 17522107111403053621)
    assert_equal(hash(SIMD[DType.int64, 4](-1)), 17522107111403053621)

    assert_equal(hash(Scalar[DType.int8](0)), 14824966480498192933)
    ...
    assert_equal(hash(Scalar[DType.int32](0)), 14824966480498192933)
