...
def test_hash_simd_values():
    ...
    assert_equal(hash(Scalar[DType.float16](1.5)), 12636464265834235359)
    assert_equal(hash(Scalar[DType.float32](1.5)), 8026467504136239071)
    assert_equal(hash(Scalar[DType.float64](1.5)), 15000291120250992607)
    assert_equal(hash(Scalar[DType.float16](1)), 12637027215787879391)
    assert_equal(hash(Scalar[DType.float32](1)), 3414781483884328927)
    assert_equal(hash(Scalar[DType.float64](1)), 14020758201297909727)

    assert_equal(hash(Scalar[DType.bool](True)), 12638152016183539244)
    assert_equal(hash(Scalar[DType.int8](1)), 12638152016183539244)
    assert_equal(hash(Scalar[DType.int16](1)), 12638152016183539244)
    assert_equal(hash(Scalar[DType.int32](1)), 12638152016183539244)
    assert_equal(hash(Scalar[DType.int64](1)), 12638152016183539244)
    assert_equal(hash(Scalar[DType.int128](1)), 589727492704079044)
    assert_equal(hash(SIMD[DType.int64, 2](1, 0)), 589727492704079044)
    assert_equal(hash(Scalar[DType.int256](1)), 12478008331234465636)
    assert_equal(hash(SIMD[DType.int64, 4](1, 0, 0, 0)), 12478008331234465636)

    assert_equal(hash(Scalar[DType.int8](-1)), 12638352127299873646)
    assert_equal(hash(Scalar[DType.int16](-1)), 12690424998011946606)
    assert_equal(hash(Scalar[DType.int32](-1)), 7718450949043144302)
    assert_equal(hash(Scalar[DType.int64](-1)), 5808589858502755950)
    assert_equal(hash(Scalar[DType.int128](-1)), 591639543425159523)
    assert_equal(hash(SIMD[DType.int64, 2](-1)), 591639543425159523)
    assert_equal(hash(Scalar[DType.int256](-1)), 16463485165778154321)
    assert_equal(hash(SIMD[DType.int64, 4](-1)), 16463485165778154321)

    assert_equal(hash(Scalar[DType.int8](0)), 12638153115695167455)
    ...
    assert_equal(hash(Scalar[DType.int32](0)), 12638153115695167455)
